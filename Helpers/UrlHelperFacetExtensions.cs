...
namespace MealsToGo.Helpers {
    public static class UrlHelperFacetExtensions {
        ...
        public static string SetFacetQueries(this UrlHelper helper, string field, string value)
        {
            return helper.SetQueryParameters(helper.RequestContext.HttpContext.Request.RawUrl, new Dictionary<string, object> {
                {"facet.query", value},
                {"page", 1},
            });
        }
        ...
        public static string SetAction(this UrlHelper helper)
        {
           string rawurl = helper.RequestContext.HttpContext.Request.RawUrl;

           return rawurl.Substring(5, rawurl.Length-5);
        }
